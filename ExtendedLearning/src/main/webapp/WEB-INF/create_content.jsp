		...
		<div class="main-container">
			<div class="cards">
				<form action="attemptCreateTopic.do" method="POST">
					...
					<br> <label>Resource</label><br> <input type="text"
						name="resourceTitle" placeholder="title"><input type="url"
						name="resourceUrl" placeholder="resource url"><br> <input
						type="text" name="resourceTitle" placeholder="title"> <label>Image
						Link</label> <input type="url" name="resourceUrl"
						placeholder="resource url"><br>
